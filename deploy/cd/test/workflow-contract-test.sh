...
require_line 'aws-actions/configure-aws-credentials@v6'
...
require_line 'Smoke test security headers'
require_line 'https://tong-yibin.com/api/public/site-config?lang=zh'
require_line 'Strict-Transport-Security: max-age=31536000'
require_line 'X-Content-Type-Options: nosniff'
require_line 'Referrer-Policy: strict-origin-when-cross-origin'
require_line 'X-Frame-Options: DENY'
require_line 'Permissions-Policy: camera=(), microphone=(), geolocation=()'

...
| 博客端 | 首页、文章、分类、标签、归档、搜索、关于、友链、留言板、文章评论、PASSWORD 解锁、作者资料和统计已接入 V2 |
...
- GitHub Actions 的最新成功 CI 为 [`29642258085`](https://github.com/tongchang01/My-Blog/actions/runs/29642258085)，对应提交 `13deaee1a60cd6599571fedfb5df5e44393e9e0c`；五项检查包含真实 MySQL 8.4 并发与迁移测试。
- 同一提交的镜像发布与生产部署为 [`29642258076`](https://github.com/tongchang01/My-Blog/actions/runs/29642258076)；Node 24 Actions 完成同 SHA 部署、三条公网 `/healthz` 冒烟和临时 SSH 入站撤销。

...
> 此例保留 V1 习惯的 AUTO_INCREMENT / TIMESTAMP / 单列软删，已被 ADR-0015 / ADR-0018 全面替换。新表请按 `../architecture/schema-design.md` + ADR-0015 的 8 列基线撰写。
...
- 依赖：ADR-0013
- 后续 arch：`../architecture/schema-design.md`（按本原则设计的全部新表）

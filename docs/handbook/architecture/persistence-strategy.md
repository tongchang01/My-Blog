...
> 最后校准：2026-07-10
> 对应代码：`MyBlog-springboot-v2/src/main/java/com/tyb/myblog/v2/*/infrastructure/persistence/`、`MyBlog-springboot-v2/src/main/resources/mapper/`、`MyBlog-springboot-v2/src/main/resources/db/migration/`
> 权威程度：架构权威说明

...
| MySQL session | DataSource 连接 URL 设 `serverTimezone=Asia/Tokyo`；`time_zone='+09:00'` |
...
```
jdbc:mysql://host:3306/myblog?serverTimezone=Asia/Tokyo&characterEncoding=utf8mb4
```

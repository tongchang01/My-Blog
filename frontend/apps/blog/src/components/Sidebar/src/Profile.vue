      ...
      >
        ...
        >
          <p
            ...
            class="flex-1 pt-6 px-8 w-full text-sm leading-8 text-center whitespace-pre-line"
          >
          ...
          <p
            ...
            class="flex w-full flex-1 self-center items-center justify-center gap-1 text-base"
          >
            <SvgIcon
              icon-class="location"
              fill="none"

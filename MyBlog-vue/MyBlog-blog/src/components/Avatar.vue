...
export default defineComponent({
  ...
  setup(props) {
    ...
    return {
      ...
      default: computed(() => appStore.websiteConfig.touristAvatar || 'https://tyb-blog-s3.s3.ap-northeast-1.amazonaws.com/aurora/config/1510640dba6def7d3df69836dd534543.gif')
    }
  }
})
</script>
